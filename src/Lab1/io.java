...
private JLabel labelbttn = new JLabel("êíîïêà èíôîðìàöèè äîáàâëåíà");
private JTextField input = new JTextField("");
private JButton button = new JButton("Ðàññ÷èòàòü ì^3");
private JButton buttonsm = new JButton("Ðàññ÷èòàòü cì^3");
private JButton button2 = new JButton("Ìíåìîñõåìà");
private JButton buttoninfo = new JButton("Èíôîðìàöèÿ");
private JLabel label = new JLabel("ÏÈ-320");
private JLabel labelFGB = new JLabel("ÔÃÁÎÓ ÂÎ");
private JLabel label2 = new JLabel("Àáðàøèòîâ Àðò¸ì Ìàðàòîâè÷");
private JLabel label22 = new JLabel("Àáðàøèòîâ Àðò¸ì Ìàðàòîâè÷ lekciipobd@gmail.com");
private JLabel label2 = new JLabel("Àáðàøèòîâ1 Àðò¸ì1 Ìàðàòîâè÷ lolkash52@gmail.com");
private JLabel label22 = new JLabel("Àáðàøèòîâ2 Àðò¸ì2 Ìàðàòîâè÷ ");
private JLabel label3 = new JLabel();
private JLabel labelUSATU = new JLabel("Óôèìñêèé ãîñóäàðñòâåííûé àâèàöèîííûé òåõíè÷åñêèé óíèâåðñèòåò");
public io() {
...
class ButtonEventListener implements ActionListener{
	public void actionPerformed(ActionEvent e) {
		...
		label3.setText("Îáúåì ïàðàëëåëîãðàììà = "+value/1000+"ì^3");
	}
}
...
class SMB implements ActionListener{
	public void actionPerformed(ActionEvent e) {
		...
		label3.setText("Îáúåì ïàðàëëåëîãðàììà = "+value+"cì^3");
	}
}
